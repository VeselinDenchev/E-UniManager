...
namespace EUniManager.Persistence.Migrations
{
    ...
    [Migration("20240812202244_Update_unique_constraint_in_Specialties_to_Name_EducationType_FirstAcademicYear")]
    partial class Update_unique_constraint_in_Specialties_to_Name_EducationType_FirstAcademicYear
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EUniManager.Domain.Entities.AssignmentSolution", b =>
                {
                    ...
                    b.ToTable("AssignmentSolutions", t =>
                        {
                            t.HasCheckConstraint("CK_AssignmentSolution_Mark", "Mark IS NULL OR Mark BETWEEN 2 AND 6");

                            t.HasCheckConstraint("CK_AssignmentSolution_MarkedOn_SubmittedOn", "MarkedOn IS NULL OR MarkedOn > SubmittedOn");
                            ...
                            t.HasCheckConstraint("CK_AssignmentSolution_SubmittedOn_SeenOn", "SubmittedOn IS NULL OR SubmittedOn > SeenOn");
                        });
                });
            ...
            modelBuilder.Entity("EUniManager.Domain.Entities.Specialty", b =>
                {
                    ...
                    b.HasIndex("Name", "EducationType", "FirstAcademicYearStart")
                        .IsUnique()
                        .HasDatabaseName("IX_Name_EducationType_FirstAcademicYearStart");
            ...
            modelBuilder.Entity("EUniManager.Domain.Entities.SubjectMark", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SubjectMarks", t =>
                        {
                            t.HasCheckConstraint("CK_SubjectMark_Mark", "Mark BETWEEN 2 AND 6");

                            t.HasCheckConstraint("CK_SubjectMark_ModifiedAt", "ModifiedAt >= CreatedAt");
                        });
                });
            ...
            modelBuilder.Entity("EUniManager.Domain.Entities.Assignment", b =>
                {
                    b.HasOne("EUniManager.Domain.Entities.Resource", "Resource")
                        .WithOne("Assignment")
                        .HasForeignKey("EUniManager.Domain.Entities.Assignment", "ResourceId");
