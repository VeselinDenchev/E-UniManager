...
namespace EUniManager.Persistence.Migrations
{
    ...
    [Migration("20240503094406_Add_Title_StartDate_and_DueDate_to_Assignment")]
    partial class Add_Title_StartDate_and_DueDate_to_Assignment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EUniManager.Domain.Entities.CourseSchedule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CourseScheduleCourseScheduleUnit", b =>
                {
                    b.HasOne("EUniManager.Domain.Entities.CourseSchedule", null)
                        .WithMany()
                        .HasForeignKey("CourseSchedulesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EUniManager.Domain.Entities.CourseScheduleUnit", null)
                        .WithMany()
