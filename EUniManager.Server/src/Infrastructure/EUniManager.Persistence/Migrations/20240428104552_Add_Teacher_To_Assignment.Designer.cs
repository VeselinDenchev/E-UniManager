...
namespace EUniManager.Persistence.Migrations
{
    ...
    [Migration("20240428104552_Add_Teacher_To_Assignment")]
    partial class Add_Teacher_To_Assignment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseScheduleCourseScheduleUnit", b =>
                {
                    ...
                    b.HasKey("CourseSchedulesId", "UnitsId");

                    b.HasIndex("UnitsId");

                    b.ToTable("CourseScheduleCourseScheduleUnit");
                });

            modelBuilder.Entity("EUniManager.Domain.Entities.Assignments.Assignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EUniManager.Domain.Entities.Assignments.AssignmentSolution", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EUniManager.Domain.Entities.Courses.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EUniManager.Domain.Entities.Courses.CourseSchedule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CourseSchedules", t =>
                        {
                            t.HasCheckConstraint("CK_CourseSchedule_ModifiedAt", "ModifiedAt >= CreatedAt");
                        });
                });

            modelBuilder.Entity("EUniManager.Domain.Entities.Courses.CourseScheduleUnit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CourseScheduleUnits", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_CourseScheduleUnit_Semester", "Semester BETWEEN 1 AND 16");
                        });
                });

            modelBuilder.Entity("EUniManager.Domain.Entities.CurriculumSubjectResourcesUnit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CurriculumSubjectResourcesUnits", t =>
                        {
                            t.HasCheckConstraint("CK_CurriculumSubjectResourcesUnit_Semester", "Semester BETWEEN 1 AND 16");
                        });
                });
            ...
            modelBuilder.Entity("EUniManager.Domain.Entities.Resource", b =>
                {
                    ...
                    b.Property<Guid>("CurriculumSubjectResourcesUnitId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CurriculumSubjectResourcesUnitId");
            ...
            modelBuilder.Entity("EUniManager.Domain.Entities.Students.Diploma", b =>
                {
                    ...
                    b.Property<string>("EducationalAndQualificationalDegree")
                        .IsRequired()
                        .HasMaxLength(30)
                        .IsUnicode(false)
                        .HasColumnType("varchar(30)");
            ...
            modelBuilder.Entity("AssignmentStudent", b =>
                {
                    b.HasOne("EUniManager.Domain.Entities.Assignments.Assignment", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CourseScheduleCourseScheduleUnit", b =>
                {
                    b.HasOne("EUniManager.Domain.Entities.Courses.CourseSchedule", null)
                        .WithMany()
                        .HasForeignKey("CourseSchedulesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EUniManager.Domain.Entities.Courses.CourseScheduleUnit", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EUniManager.Domain.Entities.Assignments.AssignmentSolution", b =>
                {
                    b.HasOne("EUniManager.Domain.Entities.Assignments.Assignment", "Assignment")
                        .WithMany("Solutions")
            ...
            modelBuilder.Entity("EUniManager.Domain.Entities.CurriculumSubjectResourcesUnit", b =>
                {
                    b.HasOne("EUniManager.Domain.Entities.Subject", "Subject")
                        .WithMany("CurriculumSubjectResources")
                        .HasForeignKey("SubjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EUniManager.Domain.Entities.Resource", b =>
                {
                    b.HasOne("EUniManager.Domain.Entities.CurriculumSubjectResourcesUnit", "CurriculumSubjectResourcesUnit")
                        .WithMany("Resources")
                        .HasForeignKey("CurriculumSubjectResourcesUnitId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("CurriculumSubjectResourcesUnit");
            ...
            modelBuilder.Entity("EUniManager.Domain.Entities.Students.Diploma", b =>
                {
                    b.HasOne("EUniManager.Domain.Entities.Students.Student", "Student")
                        .WithOne("DiplomaOwned")
                        .HasForeignKey("EUniManager.Domain.Entities.Students.Diploma", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("EUniManager.Domain.Abstraction.Student.CityArea", "CityArea", b1 =>
                        {
                            b1.Property<Guid>("DiplomaId")
                                .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EUniManager.Domain.Entities.Students.Student", b =>
                {
                    b.HasOne("EUniManager.Domain.Entities.Courses.CourseSchedule", "CourseSchedule")
                        .WithMany("Students")
                    ...
                    b.OwnsOne("EUniManager.Domain.Entities.Students.Enrollment", "Enrollment", b1 =>
                        {
                    ...
                    b.OwnsOne("EUniManager.Domain.Entities.Students.PersonalData", "PersonalData", b1 =>
                        {
                            ...
                            b1.Property<string>("Citizienship")
                                .IsRequired()
                                .HasMaxLength(20)
                                .IsUnicode(false)
                                .HasColumnType("varchar(20)")
                                .HasColumnName("Citizienship");
                            ...
                            b1.Property<string>("InsuraceNumber")
                                .HasMaxLength(10)
                                .IsUnicode(false)
                                .HasColumnType("varchar(10)")
                                .HasColumnName("InsuraceNumber");
                    ...
                    b.OwnsOne("EUniManager.Domain.Abstraction.Student.Residence", "PermanentResidence", b1 =>
                        {
                            b1.Property<Guid>("StudentId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.OwnsOne("EUniManager.Domain.Abstraction.Student.CityArea", "CityArea", b2 =>
                                {
                                    b2.Property<Guid>("ResidenceStudentId")
                                        .HasColumnType("uniqueidentifier");
                                    ...
                                    b2.HasKey("ResidenceStudentId");

                                    b2.ToTable("Students");

                                    b2.WithOwner()
                                        .HasForeignKey("ResidenceStudentId");
                                });
                    ...
                    b.OwnsOne("EUniManager.Domain.Abstraction.Student.Residence", "TemporaryResidence", b1 =>
                        {
                            b1.Property<Guid>("StudentId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.Navigation("TemporaryResidence")
                        .IsRequired();
            ...
            modelBuilder.Entity("EUniManager.Domain.Entities.Subject", b =>
                {
                    b.HasOne("EUniManager.Domain.Entities.Courses.Course", "Course")
                        .WithMany("Subjects")
            ...
            modelBuilder.Entity("EUniManager.Domain.Entities.Subject", b =>
                {
                    b.Navigation("CourseScheduleUnits");

                    b.Navigation("CurriculumSubjectResources");
