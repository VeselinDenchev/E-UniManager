...
namespace EUniManager.Persistence.Migrations
{
    ...
    [Migration("20240505192758_Drop_Name_and_change_Id_columns_to_VARCHAR(36)_in_CloudinaryFile_table")]
    partial class Drop_Name_and_change_Id_columns_to_VARCHAR36_in_CloudinaryFile_table
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EUniManager.Domain.Entities.Resource", b =>
                {
                    ...
                    b.Property<Guid>("SubjectResourcesUnitId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("SubjectResourcesUnitId");
            ...
            modelBuilder.Entity("EUniManager.Domain.Entities.SubjectResourcesUnit", b =>
                {
                    ...
                    b.ToTable("SubjectResourcesUnits", t =>
                        {
                            t.HasCheckConstraint("CK_SubjectResourcesUnit_Semester", "Semester BETWEEN 1 AND 16");
                        });
                });
            ...
            modelBuilder.Entity("EUniManager.Domain.Entities.Resource", b =>
                {
                    ...
                    b.Navigation("SubjectResourcesUnit");
                });
